...
## Examples
For detailed examples on how to use this module, please refer to the [Examples](https://github.com/cypik/terraform-google-template-instance/tree/master/examples) directory within this repository.
